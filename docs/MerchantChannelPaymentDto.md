...
| **sources** | **Array&lt;String&gt;** | The address source of the payment. | [optional] |
| **network_fee** | [**NetworkFeeDto**](NetworkFeeDto.md) |  | [optional] |
...
instance = OpenapiClient::MerchantChannelPaymentDto.new(
