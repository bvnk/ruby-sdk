...
module OpenapiClient
  ...
  class GatewayTransactionDto
    ...
    attr_accessor :network_fee_currency
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::GatewayTransactionDto` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::GatewayTransactionDto`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'date_confirmed')
        self.date_confirmed = attributes[:'date_confirmed']
      end
      ...
      if attributes.key?(:'network_fee_currency')
        self.network_fee_currency = attributes[:'network_fee_currency']
      end

      if attributes.key?(:'network_fee_amount')
        self.network_fee_amount = attributes[:'network_fee_amount']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          amount == o.amount &&
          risk == o.risk &&
          network_fee_currency == o.network_fee_currency &&
          network_fee_amount == o.network_fee_amount &&
          sources == o.sources &&
    ...
    def hash
      [date_created, date_confirmed, hash, amount, risk, network_fee_currency, network_fee_amount, sources, display_rate, exchange_rate].hash
    end
